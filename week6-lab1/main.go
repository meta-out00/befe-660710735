...
import (
    "fmt"
    "net/http"
    "github.com/gin-gonic/gin" //ไม่ใช่ stardard
	"slices"
)
...
func getStudent(c *gin.Context){
	...
	c.JSON(http.StatusNotFound, gin.H{"error":"student not found"})//.H ใช้สร้าง message
}
...
func main() {
	...
	api := r.Group("/api/v1")
	{
		...
		api.GET("/students/:id", getStudent)//gin จะรู้ว่า id คือ ตัวแปร
