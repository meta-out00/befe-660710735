...
const HomePage = () => {
  ...
  return (
    <div className="min-h-screen">
      {/* Hero Section */}
      <section className="relative bg-amber-100 text-white">
        <div className="container mx-auto px-4 py-24">
          <div className="max-w-3xl">
            <h1 className="text-5xl md:text-6xl font-bold mb-6 animate-fade-in text-gray-500">
            ...
            <div className="flex flex-col sm:flex-row gap-4 text-gray-500">
              ...
              <Link to="/categories" 
                ...
                border-2 border-white font-semibold rounded-lg 
